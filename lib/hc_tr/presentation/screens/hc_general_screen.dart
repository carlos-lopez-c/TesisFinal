    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          NavigationButton(
            navigationRoute: (context) => SearchHcTrGeneral(),
          ),
          _buildSection('1.- DATOS INFORMATIVOS'),
          _buildFormField('Fecha de la entrevista (dd/mm/aaaa)'),
          _buildFormField('Evaluador'),
          _buildFormField('Nombre completo'),
          Row(
            children: [
              Expanded(
                  child: _buildFormField('Fecha de Nacimiento (dd/mm/aaaa)')),
